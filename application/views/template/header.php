...
<html lang="en">
	<head>
		...
		<title>Pericia Forense Digital</title>
		<!-- Bootstrap core CSS -->
		...
		<nav class="navbar navbar-default navbar-shrink navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header page-scroll">
					...
					<a class="navbar-brand page-scroll" href="/web"><img src="<?php echo base_url(); ?>public/images/logo.png" alt="Lattes theme logo"></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a class="page-scroll" href="criptografia">Criptografia</a>
						</li>
						<li>
							<a class="page-scroll" href="<?php echo base_url(); ?>restrito">Acesso</a>
						</li>
					</ul>
				</div>
				<!-- /.navbar-collapse -->
